...
ActiveRecord::Schema.define(version: 20140710212422) do
  ...
  create_table "groups_images", id: false, force: true do |t|
    t.integer "group_id"
    t.integer "image_id"
  end

  add_index "groups_images", ["group_id"], name: "index_groups_images_on_group_id", using: :btree
